        ...
        <div className="container">
            <div className="row">
              <Breadcrumb>
                  ...
                  <BreadcrumbItem active>Cantact Us</BreadcrumbItem>
              </Breadcrumb>
              ...
              <div className="clo-12 col-md-9">
                <Form onsSubmit={this.handleSubmit}>
                    ...
                    <FormGroup row>
                      ...
                      <Col md={10}>
                          <Input type="email" id="email" name="email" placeholder="Email" value={this.state.eamil} onChange={this.handleInputChange}/>
                      </Col>
                    </FormGroup>
                    <FormGroup row>
                      ...
                      <Col md={{size:3,offset:1}}>
                          <Input type="select" name="cantactType" value={this.state.contactType} onChange={this.handleInputChange}>
                            <option>Tel.</option>
                            <option>Email</option>
                          </Input>
                      </Col>
